...
export default class ScratchCat extends Sprite {
  constructor(...args) {
    ...
    this.costumes = [
      new Costume("Scratch Cat", "./ScratchCat/costumes/Scratch Cat.svg", {
        x: 55.245225000000005,
        y: 44.10070999999999
      }),
      new Costume("Main Hitbox", "./ScratchCat/costumes/Main Hitbox.svg", {
        x: 49.24595500000001,
        y: 16.167480000000012
      }),
      new Costume("Left Hitbox", "./ScratchCat/costumes/Left Hitbox.svg", {
        x: -87.39035999999999,
        y: 66.571655
      }),
      new Costume("Right Hitbox", "./ScratchCat/costumes/Right Hitbox.svg", {
        x: -86.820245,
    ...
    this.vars.speed = 2.1757385907535554;
    this.vars.slow = 0;
    this.vars.speedOffset = 0;
    this.vars.randomSpeed = 2.1757385907535554;
    this.vars.lap = 1;
    this.vars.finish = 0;
    this.vars.name = "Scratch";
    this.vars.hideName = "N";
  }

  *whenGreenFlagClicked() {
    this.visible = false;
    yield* this.helloMyNameIs("Scratch Cat");
  }
