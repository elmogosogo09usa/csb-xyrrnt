...
export default class CutePikachu extends Sprite {
  constructor(...args) {
    super(...args);

    this.costumes = [
      new Costume("Cute Pikachu", "./CutePikachu/costumes/Cute Pikachu.svg", {
        x: 55.24509499999999,
        y: 44.10070999999999
      }),
      new Costume("Main Hitbox", "./CutePikachu/costumes/Main Hitbox.svg", {
        x: 49.24595500000001,
        y: 16.167480000000012
      }),
      new Costume("Left Hitbox", "./CutePikachu/costumes/Left Hitbox.svg", {
        x: -87.39035999999999,
        y: 66.571655
      }),
      new Costume("Right Hitbox", "./CutePikachu/costumes/Right Hitbox.svg", {
        x: -86.820245,
    ...
    this.vars.speed = 2.8009545658203496;
    this.vars.slow = 0;
    this.vars.speedOffset = 0;
    this.vars.randomSpeed = 2.8009545658203496;
    this.vars.lap = 1;
    this.vars.finish = 0;
    this.vars.name = "Cute Pikachu";
    this.vars.hideName = "N";
  }

  *whenGreenFlagClicked() {
    this.visible = false;
    yield* this.helloMyNameIs("Cute Pikachu");
  }
